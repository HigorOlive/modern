  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form>
      ...
      <header>
        <div id=pagHistoria>
        <h1>A equipe</h1>
        <p class="lead text-left">Hortaliças é um grupo criado na ETEC Horácio Augusto Silveira para os
           projetos e trabalhos do primeiro semestre do curso de Desenvolvimento de Sistemas. 
          <br> Atualmente, estamos trabalhando na solução do projeto de conclusão do primeiro semestre.</p><br>
          <div id="map">
              ...
              <br><br>
              <h2>Os membros</h2>
              <p class="lead text-center">A equipe é composta por 6 membros, todos estudantes da ETEC:</p>
		<!--tabela com fotos dos intergantes do grupo-->
		<table border="0" class="table">
			<tr>
				<td><img src="img/Daniel.jpeg" alt="..." class="rounded-circle img-fluid" id="table"></td>
				<td><img src="img/Daniel.jpeg" alt="..." class="rounded-circle img-fluid" id="table"></td>
				<td><img src="img/Daniel.jpeg" alt="..." class="rounded-circle img-fluid" id="table"></td>
				<td><img src="img/Daniel.jpeg" alt="..." class="rounded-circle img-fluid" id="table"></td>
				<td><img src="img/Daniel.jpeg" alt="..." class="rounded-circle img-fluid" id="table"></td>
